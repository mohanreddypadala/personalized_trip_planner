...
https://docs.djangoproject.com/en/5.0/ref/settings/#values
"""
...
# personalized_trip_planner/settings.py


load_dotenv()
print(f"DEBUG: USE_MOCK_AI_CLIENT is currently read as: {os.getenv('USE_MOCK_AI_CLIENT')}")
...
SECRET_KEY = os.getenv("DJANGO_SECRET_KEY", "django-insecure-your-very-secret-key-here") # IMPORTANT: Change in production

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = os.getenv("DJANGO_DEBUG", "True") == "True"

ALLOWED_HOSTS = ['*'] # Restrict this in production, e.g., ['yourdomain.com', '127.0.0.1']
...
INSTALLED_APPS = [
    ...
    'core',             # Add this line for the new app
    'trip_planner_app', # Your existing application
]
...
# Password validation
# https://docs.djangoproject.com/en/5.0/ref/databases/#auth-password-validators
...
STATIC_URL = '/static/'
STATICFILES_DIRS = [
    os.path.join(BASE_DIR, 'static'), # Project-level static files (e.g., global_style.css, logo.png)
]
...
# Session settings for storing itinerary data
